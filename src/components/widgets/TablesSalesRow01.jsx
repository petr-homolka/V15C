// figma node: 12070:3934 Tables / Sales / Row 01
export function TablesSalesRow01(_p = {}) {
  const props = _p;
  return (
    <div className={props.className} style={{
      ...
      <span style={{
        ...
        lineHeight: "21px",
        color: "rgb(28,29,33)",
      }}>{props.text1 ?? "4255 Murazik Trace Apt. 998"}</span>
      <span style={{
        position: "absolute",
        left: 422,
        top: 15,
...
export default TablesSalesRow01;
